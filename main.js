...
scene("menu", () => {
    ...
    playBtn.onClick(async () => {
        ...
        let rawName = prompt("ENTER YOUR NAME MANAGER:", "Ren");

        if (!rawName || rawName.trim() === "") {
            currentPlayerName = "Ren";
        } else {
            currentPlayerName = rawName.trim().substring(0, 12); // Prevent name card layouts from breaking
        }
